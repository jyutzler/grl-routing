...
Internal reference number of this OGC® document: OGC 12-128r11 +
Version: 1.0.1 +
...
ogcdoc, geopackage, sqllite, raster, tiles, vector, feature, data, storage, exchange, mobile, smartphone, tablet, elevation, tiff
